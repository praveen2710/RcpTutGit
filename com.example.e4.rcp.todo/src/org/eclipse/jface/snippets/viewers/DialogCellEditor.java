 ...
 * <ul>
 *	<li>createButton: creates the cell editor's button control
 *	<li>createContents: creates the cell editor's 'display value' control
 *	<li>updateContents: updates the cell editor's 'display value' control
 * 		after its value has changed</li>
 *	<li>openDialogBox: opens the dialog box when the end user presses
 *      the button</li>
 * </ul>
 * </p>
 */
public abstract class DialogCellEditor extends CellEditor {
    ...
    /**
     * Image registry key for three dot image (value <code>"cell_editor_dots_button_image").
     */
    ...
    /**
     * The label that gets reused by <code>updateLabel.
     */
    ...
    /**
     * The value of this cell editor; initially <code>null.
     */
     ...
     * The cell editor value is <code>null initially, and has no 
     * validator.
     *
     ...
     * should also reimplement <code>updateContents.
     * </p>
     *
    ...
    /**
     * Returns the default label widget created by <code>createContents.
     *
     ...
     * dialog's value when it closes, or <code>null if the dialog
     ...
     * @return the selected value, or <code>null if the dialog was 
     ...
     * the passed object to a string using <code>toString and
     * sets this as the text of the label widget.
     * </p>
     * <p>
     * Subclasses may reimplement.  If you reimplement this method, you
     * should also reimplement <code>createContents.
     * </p>
     *
